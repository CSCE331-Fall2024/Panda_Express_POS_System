  ...
  const categories: MenuCategory[] = ['Combos', 'Appetizers', 'Entrees', 'Sides', 'Drinks'];
    ...
    return (
      ...
      >
        ...
        <a href="/customer" style={{ color: '#FFFFFF', textDecoration: 'none', display: 'flex', alignItems: 'center', position: 'absolute', left: '50%', transform: 'translateX(-50%)'}}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          {/* Sign In Text */}
          <a href="/login" style={{ color: '#FFFFFF', textDecoration: 'none', display: 'flex', alignItems: 'center'}}>
